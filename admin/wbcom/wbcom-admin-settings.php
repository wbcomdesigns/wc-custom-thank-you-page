...
if ( ! class_exists( 'Wbcom_Admin_Settings' ) ) {
	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_all_free_plugins() {
			$free_plugins = array(
				'0'  => array(
					'name'        => esc_html__( 'Custom Font Uploader', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'custom-font-uploader',
					'description' => esc_html__( 'It also allows you to upload your own custom font to your site and use them using custom css.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'custom-font-uploader' ),
					'wp_url'      => 'https://wordpress.org/plugins/custom-font-uploader/',
					'icon'        => 'fa fa-upload',
				),
				'1'  => array(
					'name'        => esc_html__( 'BuddyPress Activity Filter', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-activity-filter',
					'description' => esc_html__( 'Admin can set default and customised activities to be listed on front-end.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'bp-activity-filter' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-activity-filter/',
					'icon'        => 'fa fa-filter',
				),
				'2'  => array(
					'name'        => esc_html__( 'BuddyPress Activity Social Share', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-activity-social-share',
					'description' => esc_html__( 'This plugin allows anyone easily share BuddyPress Activites on major social media (Facebook, Twitter, Google+, Linkedin ).', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'bp-activity-social-share' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-activity-social-share/',
					'icon'        => 'fa fa-share-alt',
				),
				'3'  => array(
					'name'        => esc_html__( 'BuddyPress Create Group Type', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-create-group-type',
					'description' => esc_html__( 'It will help to create group type for BuddyPress Groups.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'bp-create-group-type' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-create-group-type/',
					'icon'        => 'fa fa-sitemap',
				),
				'4'  => array(
					'name'        => esc_html__( 'BuddyPress Member Reviews', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-user-profile-reviews',
					'description' => esc_html__( 'This plugin allows only site members to add reviews to the buddypress members on the site and even rate the member’s profile out of 5 points with multiple review criteria.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'bp-user-profile-reviews' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-user-profile-reviews/',
					'icon'        => 'fa fa-user',
				),
				'5'  => array(
					'name'        => esc_html__( 'BuddyPress Group Reviews', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'review-buddypress-groups',
					'description' => esc_html__( 'This plugin allows the BuddyPress Members to give reviews to the BuddyPress groups on the site. The review form allows the users to give text review, even rate the group on the basis of multiple criterias.', WCCTP_TEXT_DOMAIN ),
				...
				'6'  => array(
					'name'        => esc_html__( 'BuddyPress Favorite Notification', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-favorite-notification',
					'description' => esc_html__( 'BuddyPress Favorite Notification adds a notification for BuddyPress activity.', WCCTP_TEXT_DOMAIN ),
				...
				'7'  => array(
					'name'        => esc_html__( 'Custom Email Options', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'custom-email-options',
					'description' => esc_html__( 'Override default email options of Worpdress.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'custom-email-options' ),
					'wp_url'      => 'https://wordpress.org/plugins/custom-email-options/',
					'icon'        => 'fa fa-2x fa-at',
				),
				'8'  => array(
					'name'        => esc_html__( 'BuddyPress Checkins', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-check-in',
					'description' => esc_html__( 'This plugin allows BuddyPress members to share their location when they are posting activities, you can add places where you visited, nearby locations based on google places.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'bp-check-in' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-check-in/',
					'icon'        => 'fa fa-2x fa fa-map-marker',
				),
				'9'  => array(
					'name'        => esc_html__( 'BuddyPress Job Manager', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-job-manager',
					'description' => esc_html__( 'Incorporates BuddyPress with the WP Job Manager plugin by creating specific tabs in employer’s and candidate’s profiles.', WCCTP_TEXT_DOMAIN ),
				...
				'10' => array(
					'name'        => esc_html__( 'BuddyPress user ToDo List', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-user-to-do-list',
					'description' => esc_html__( 'This plugin allows you to create your personal task list with timestamp. You can mark them complete when you are done with them. It will also send reminder when you have any overdue task.', WCCTP_TEXT_DOMAIN ),
				...
				'11' => array(
					'name'        => esc_html__( 'Shortcodes for BuddyPress', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'shortcodes-for-buddypress',
					'description' => esc_html__( 'This plugin will add an extended feature to the big name “BuddyPress” that will generate Shortcode for Listing Activity Streams , Members and Groups on any post/page in website.', WCCTP_TEXT_DOMAIN ),
				...
				'12' => array(
					'name'        => esc_html__( 'Woo Open Graph', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'woo-open-graph',
					'description' => esc_html__( 'This plugin will add an extended feature to the big name “WooCommerce” that will adds well executed and accurate Open Graph Meta Tags to your site with title,description and WooCommerce featured image.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'woo-open-graph' ),
					'wp_url'      => 'https://wordpress.org/plugins/woo-open-graph/',
					'icon'        => 'fa fa-bar-chart',
				),
				'13' => array(
					'name'        => esc_html__( 'BuddyPress Lock', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'lock-my-bp',
					'description' => esc_html__( 'This plugin allows the administrator to lock the certain parts of their site. It help to create private BuddyPress community by locking certain BuddyPress Components, WordPress Pages, Custom Post Types for public view without using any membership plugin.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'lock-my-bp' ),
					'wp_url'      => 'https://wordpress.org/plugins/lock-my-bp/',
					'icon'        => 'fa fa-2x fa-lock',
				),
				'14' => array(
					'name'        => esc_html__( 'Woo Audio Preview', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'woo-audio-preview',
					'description' => esc_html__( 'This plugin Allows playing the audio files in sample mode to prevent unauthorized downloading of the audio files. It helps to display sample files at single product page.', WCCTP_TEXT_DOMAIN ),
				...
				'15' => array(
					'name'        => esc_html__( 'WordPress System Log', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'wp-system-log',
					'description' => esc_html__( 'This plugin helps administrators of the site see their environment on which the site is currently running that includes WordPress environment, tha database it requires, Server Environment and the plugins installed and activated on the site.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'wp-system-log' ),
					'wp_url'      => 'https://wordpress.org/plugins/wp-system-log/',
					'icon'        => 'fa fa-file-text',
				),
				'16' => array(
					'name'        => esc_html__( 'BP Post From Anywhere', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'bp-post-from-anywhere',
					'description' => esc_html__( 'This plugin will generate shortcode and widgets for post updates section for activities so you can post update from anywhere, it might be sidebar, some page or any template file.', WCCTP_TEXT_DOMAIN ),
				...
				'17' => array(
					'name'        => esc_html__( 'Woo Document Preview', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'woo-document-preview',
					'description' => esc_html__( 'This will allow you to add document preview at single product page. Which helps to offer more better idea when you are selling ebooks, pdf or some documents.', WCCTP_TEXT_DOMAIN ),
				...
				'18' => array(
					'name'        => esc_html__( 'WordPress Media Category', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'media-category',
					'description' => esc_html__( 'This plugin helps administrators of the site categorize their wordpress media.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'media-category' ),
					'wp_url'      => 'https://wordpress.org/plugins/media-category/',
					'icon'        => 'fa fa-picture-o',
				),
				'19' => array(
					'name'        => esc_html__( 'Woo Price Quotes', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'woo-price-quote-inquiry',
					'description' => esc_html__( 'This plugin helps in quoting the products that admin wishes to hide its purchasing details.', WCCTP_TEXT_DOMAIN ),
					'status'      => $this->wbcom_plugin_status( 'woo-price-quote-inquiry' ),
					'wp_url'      => 'https://wordpress.org/plugins/woo-price-quote-inquiry/',
					'icon'        => 'fa fa-usd',
				),
				'20' => array(
					'name'        => esc_html__( 'EDD Service Extended', WCCTP_TEXT_DOMAIN ),
				...
				'21' => array(
					'name'        => esc_html__( 'WB Ads Rotator with Split Test', WCCTP_TEXT_DOMAIN ),
					'slug'        => 'wb-ads-rotator-with-split-test',
					'description' => esc_html__( 'This plugin is designed for the SPLIT TESTING, you can check performance of your ads layout and on the basis of them you can select one of them for your regular use.', WCCTP_TEXT_DOMAIN ),
		...
		public function wbcom_all_paid_plugins() {
			$paid_plugins = array(
				'0' => array(
					'name'         => esc_html__( 'BuddyPress Moderation Pro', WCCTP_TEXT_DOMAIN ),
					'description'  => esc_html__( 'BuddyPress Community Moderation offers a solution for site owners to keep their communities straight. With community policing strategy, members of the community have an option for moderation sitewide by attaching flags to content created within the various components.', WCCTP_TEXT_DOMAIN ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-moderation-pro/',
					'icon'         => 'fa fa-exclamation-triangle',
				),
				'1' => array(
					'name'         => esc_html__( 'BuddyPress Polls', WCCTP_TEXT_DOMAIN ),
					'description'  => esc_html__( 'Use BuddyPress Polls plugin to create polls inside the activity, let your user response to your polls. Members can create pools like activities, easily votes on them.', WCCTP_TEXT_DOMAIN ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-polls/',
					'icon'         => 'fa fa-bar-chart',
				),
				'2' => array(
					'name'         => esc_html__( 'BuddyPress Resume Manager', WCCTP_TEXT_DOMAIN ),
					'description'  => esc_html__( 'BuddyPress Resume Manager adds a separate BuddyPress Resume menu at a user’s BuddyPress Profile Page to display individual member resume. We have added predefined fields for the resumes and site admin and enable and disable them.', WCCTP_TEXT_DOMAIN ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-resume-manager/',
					'icon'         => 'fa fa-file',
				),
				'3' => array(
					'name'         => esc_html__( 'BuddyPress Profanity', WCCTP_TEXT_DOMAIN ),
					'description'  => esc_html__( 'Use BuddyPress Profanity plugin to censor content in your community! Easily Censor all the unwanted words in activities, private messages contents by specifying a list of keywords to be filtered.', WCCTP_TEXT_DOMAIN ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-profanity/',
					'icon'         => 'fa fa-hand-peace-o',
				),
				'4' => array(
					'name'         => esc_html__( 'BuddyPress Private Community Pro', WCCTP_TEXT_DOMAIN ),
					'description'  => esc_html__( 'This plugin offers a lockdown for BuddyPress Component and will ask users to log in go further to check profile or any other protected details.', WCCTP_TEXT_DOMAIN ),
					'download_url' => 'https://wbcomdesigns.com/downloads/woocommerce-price-quote/',
					'icon'         => 'fa fa-user-times',
				),
				'5' => array(
					'name'         => esc_html__( 'BuddyPress Profile Pro', WCCTP_TEXT_DOMAIN ),
					'description'  => esc_html__( 'This plugin gives you the power to extend BuddyPress Profiles with repeater fields and groups. You can easily add multiple field groups and display them at member’s profile.', WCCTP_TEXT_DOMAIN ),
		...
		public function wbcom_enqueue_admin_scripts() {
			...
			if ( ! wp_script_is( 'wbcom-admin-setting-js', 'enqueued' ) ) {
				...
				wp_register_script(
					...
					$src       = WCCTP_PLUGIN_URL . '/admin/wbcom/assets/js/wbcom-admin-setting.js',
					$deps      = array( 'jquery' ),
					$ver       = time(),
					$in_footer = true
				);
				wp_localize_script(
					...
					array(
						...
						'activate_text'   => esc_html__( 'Activate', WCCTP_TEXT_DOMAIN ),
						'deactivate_text' => esc_html__( 'Deactivate', WCCTP_TEXT_DOMAIN ),
					)
				);
			...
			if ( ! wp_style_is( 'wbcom-admin-setting-css', 'enqueued' ) ) {
				wp_enqueue_style( 'wbcom-admin-setting-css', WCCTP_PLUGIN_URL . 'admin/wbcom/assets/css/wbcom-admin-setting.css' );
			}
			...
			if ( function_exists( 'get_current_screen' ) ) {
				...
				if ( 'toplevel_page_wbcomplugins' === $screen->base ) {
					...
					if ( ! wp_style_is( 'wbcom-selectize-css', 'enqueued' ) ) {
						wp_enqueue_style( 'wbcom-selectize-css', WCCTP_PLUGIN_URL . 'admin/css/selectize.css' );
					}
					if ( ! wp_script_is( 'wbcom-selectize-js', 'enqueued' ) ) {
						wp_enqueue_script( 'wbcom-selectize-js', WCCTP_PLUGIN_URL . 'admin/js/selectize.min.js', array( 'jquery' ) );
					}

					if ( ! wp_script_is( 'wp-color-picker', 'enqueued' ) ) {
						wp_enqueue_style( 'wp-color-picker' );
					}
					if ( ! wp_script_is( WCCTP_TEXT_DOMAIN, 'enqueued' ) ) {
						wp_enqueue_script( WCCTP_TEXT_DOMAIN, WCCTP_PLUGIN_URL . 'admin/js/wc-custom-thank-you-page-admin.js', array( 'jquery' ) );
					}
					if ( ! wp_style_is( WCCTP_TEXT_DOMAIN, 'enqueued' ) ) {
						wp_enqueue_style( WCCTP_TEXT_DOMAIN, WCCTP_PLUGIN_URL . 'admin/css/wc-custom-thank-you-page-admin.css', array(), time(), 'all' );
					}
				}
			}
		}
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Components', WCCTP_TEXT_DOMAIN ),
				esc_html__( 'Components', WCCTP_TEXT_DOMAIN ),
				'manage_options',
				'wbcom-plugins-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Themes', WCCTP_TEXT_DOMAIN ),
				esc_html__( 'Themes', WCCTP_TEXT_DOMAIN ),
				'manage_options',
				'wbcom-themes-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Support', WCCTP_TEXT_DOMAIN ),
				esc_html__( 'Support', WCCTP_TEXT_DOMAIN ),
				'manage_options',
				'wbcom-support-page',
		...
		public function wbcom_admin_setting_header_html() {
			...
			<div id="wb_admin_header" class="wp-clearfix">
				...
				<div id="wb_admin_logo">
					<img src="<?php echo WCCTP_PLUGIN_URL . 'admin/wbcom/assets/imgs/logowbcom.png'; ?>">
					...
					<ul>
						<li class="wb_admin_nav_item <?php echo esc_attr( $settings_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcomplugins'; ?>" id="wb_admin_nav_trigger_settings">
								...
								<h4><?php esc_html_e( 'Settings', WCCTP_TEXT_DOMAIN ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $plugin_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-plugins-page'; ?>" id="wb_admin_nav_trigger_extensions">
								...
								<h4><?php esc_html_e( 'Components', WCCTP_TEXT_DOMAIN ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $theme_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-themes-page'; ?>" id="wb_admin_nav_trigger_themes">
								...
								<h4><?php esc_html_e( 'Themes', WCCTP_TEXT_DOMAIN ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $support_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-support-page'; ?>" id="wb_admin_nav_trigger_support">
								...
								<h4><?php esc_html_e( 'Support', WCCTP_TEXT_DOMAIN ); ?></h4>
							</a>
						</li>
